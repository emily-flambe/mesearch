...
export const categories: Category[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      {
        title: 'Moral Foundations 2',
        subtitle: 'MFQ-2',
        slug: 'mfq2',
        keywords: ['Ethics', 'Values', 'Politics', 'Equality', 'Merit'],
        description: 'The updated MFQ with six foundations: Care, Equality, Proportionality, Loyalty, Authority, and Purity. Distinguishes fairness as equality vs. merit.',
        time: '10 min',
        seriousness: 5,
        fun: 4,
      },
      {
        ...
        subtitle: 'SDO7',
        slug: 'sdo7',
        keywords: ['Hierarchy', 'Equality', 'Politics'],
        description: 'Measure your orientation toward group-based hierarchy across Dominance and Anti-Egalitarianism subscales. A key predictor of political attitudes.',
        time: '5 min',
        seriousness: 5,
        fun: 3,
      },
      {
        ...
        subtitle: 'RWA-VSA',
        slug: 'rwa',
        keywords: ['Authority', 'Tradition', 'Politics'],
        description: 'A 6-item measure of authoritarian attitudes across Submission, Aggression, and Conventionalism. Quick and research-validated.',
        time: '2 min',
        seriousness: 5,
        fun: 3,
      },

...
const STORAGE_KEY = 'mesearch-skin-tone-iat-progress';
const INTER_TRIAL_INTERVAL = 250; // ms between trials

export default function SkinToneIATAssessment() {
  const { user } = useAuth();
  const [baseConfig] = useState<IATConfig>(skinToneIAT);
  ...
  // 2. targetSideSwapped: Which target starts on the left (Light Skin vs Dark Skin)
        ...
        {phase === 'intro' && (
          <div className="flex-1 flex items-center justify-center p-6">
            <div className="card-premium rounded-lg p-12 max-w-2xl w-full text-center">
              ...
              {/* Extra sensitivity notice */}
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mb-4 text-left">
                <p className="text-red-400 text-sm font-medium mb-2">
                  Sensitive Content Notice
                </p>
                <p className="text-[var(--color-text-muted)] text-xs">
                  This test explores implicit associations related to skin tone, which is a sensitive topic.
                  Results do NOT measure prejudice or moral character. They reflect automatic associations
                  that are often shaped by cultural exposure rather than personal beliefs.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <p className="text-[var(--color-text-secondary)] text-sm">
                  You will categorize items using the E and I keys as quickly as possible.
                </p>
                <button
                  onClick={startIAT}
                  className="btn-gold px-10 py-4 rounded text-sm tracking-widest uppercase"
                  data-testid="skin-tone-iat-start"
                >
                  Begin Assessment
                </button>
              </div>
          ...
          <div className="flex-1 flex items-center justify-center p-6">
            <div className="card-premium rounded-lg p-12 max-w-xl w-full text-center">
              ...
              <button
                onClick={beginTrials}
                className="btn-gold px-10 py-4 rounded text-sm tracking-widest uppercase"
                data-testid="skin-tone-iat-begin-block"
              >
                Start Block
              </button>
          ...
          <div className="flex-1 flex items-center justify-center p-6">
            <div className="card-premium rounded-lg p-12 max-w-xl w-full text-center">
              ...
              <button
                ...
                className="btn-gold px-10 py-4 rounded text-sm tracking-widest uppercase"
                data-testid="skin-tone-iat-continue"
              >
                Continue
              </button>
              <p className="text-[var(--color-text-muted)] text-xs mt-3">
